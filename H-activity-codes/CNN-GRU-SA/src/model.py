"""Model architecture for Deep CNN-GRU with Self-Attention (M4-GRU)."""
...
def build_m4_model(
    ...
    """Build the M4 CNN-GRU Self-Attention model (LSTM replaced with GRU)."""
    ...
    x = layers.GRU(128, return_sequences=False, name="gru_3")(x)

    # Projection (same as paper architecture)
