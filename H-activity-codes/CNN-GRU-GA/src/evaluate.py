...
from .model import GatedSelfAttention   # 🔹 ADDED: import custom layer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model-path", default="./results/best_model.h5", help="Path to model"
    )
...
def main() -> None:
    ...
    # 🔹 FIX: Load model with custom_objects
    model = tf.keras.models.load_model(
    args.model_path,
    custom_objects={"GatedSelfAttention": GatedSelfAttention},
)
